...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2017 at 11:07 AM
...
CREATE TABLE `customers` (
  ...
  `customer_city` varchar(222) DEFAULT NULL,
  `customer_contact` varchar(256) DEFAULT NULL,
  `customer_address` varchar(222) DEFAULT NULL,
...
(28, '::1', 'mohona', 'mohona@gmail.com', '12345', 'Bangladesh', 'Dhaka', '12345', 'd', 'images.jpg');
